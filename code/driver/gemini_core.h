...
#define GCORE_STATUS_A1_DONE_MASK         (1 << 5)
#define GCORE_STATUS_A2_DONE_MASK         (1 << 6)
#define GCORE_STATUS_A1_STARTUP_DONE_MASK (1 << 7)
#define GCORE_STATUS_A2_STARTUP_DONE_MASK (1 << 8)
#define GCORE_STATUS_CTRL_RANK_SEL_MASK   (1 << 9)
#define GCORE_STATUS_DMA_RANK_SEL_MASK    (1 << 10)

// mask all except error
#define GCORE_STATUS_ERROR_CODE_MASK 0xFFFF0000

// error masks
#define GCORE_STATUS_A1_DDR3_TEMP_ERROR_MASK (1 << 18)
#define GCORE_STATUS_A1_DCLK_PLL_ERROR_MASK  (1 << 19)
#define GCORE_STATUS_A1_MIG_RESET_ERROR_MASK (1 << 20)
#define GCORE_STATUS_A1_MIG_CALIB_ERROR_MASK (1 << 21)
#define GCORE_STATUS_A1_MIG_MMCM_ERROR_MASK  (1 << 22)
#define GCORE_STATUS_A2_DDR3_TEMP_ERROR_MASK (1 << 23)
#define GCORE_STATUS_A2_DCLK_PLL_ERROR_MASK  (1 << 24)
#define GCORE_STATUS_A2_MIG_RESET_ERROR_MASK (1 << 25)
#define GCORE_STATUS_A2_MIG_CALIB_ERROR_MASK (1 << 26)
#define GCORE_STATUS_A2_MIG_MMCM_ERROR_MASK  (1 << 27)
